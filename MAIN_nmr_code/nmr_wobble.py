...
wobble_mode = 2 # MODE 0 = SYNC FFT mode. MODE 1 = SYNC NON-FFT MODE. MODE 2 = ASYNC NON-FFT MODE
...
extSet = True  # use external executable to set the matching network Cpar and Cser
