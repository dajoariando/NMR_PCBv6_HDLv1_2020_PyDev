...
# sweep settings
cpmg_freq_sta = 4.0  # in microsecond
cpmg_freq_sto = 4.3  # in microsecond
...
for i in range(0, cpmg_freq_ste):
    ...
    #nmrObj.cpmgSequence(cpmg_freq, pulse1_us, pulse2_us, pulse1_dtcl, pulse2_dtcl, echo_spacing_us, scan_spacing_us, samples_per_echo, echoes_per_scan, init_adc_delay_compensation, number_of_iteration, ph_cycl_en, pulse180_t1_int, delay180_t1_int)
